...
<body>
	...
	<p>
		<ul>
            ...
            <li><strong>Registered email-id:</strong>
                {{ Auth::user()->email }}
            </li>
            <li><strong>Connection Id: </strong>
                {{ Auth::user()->customerId }}
            </li>
            <li><strong>Billing Address:</strong>
                 {{Auth::user()->address}}
             </li>
	            <li><strong>Bill for:</strong><span class="red">
...
<table class="tg">
  ...
  <tr>
    ...
    <td class="tg-yw4l">
        {{-- Rs.{{($data[0]->amount)/($data[0]->units)}} --}}
         per unit</td>
    <td class="tg-yw4l red"><strong>Rs.
        {{-- {{$data[0]->amount}} --}}
    </strong></td>
  </tr>
</table>
